...
/**
 * This function tests rgbToCMYK passing a single, hard-coded
 * rgb-value (234, 151, 195).
 */
static void testRgbToCmyk002(void **state) {
  double c, m, y, k;
  rgbToCMYK(234,151,195,&c,&m,&y,&k);
  assert_true(
    isClose(c, 0.0) &&
    isClose(m, .35) &&
    isClose(y, .17) &&
 ...
 * rgb-value (51, 86, 22).
 */
static void testRgbToCmyk003(void **state) {
  double c, m, y, k;
  rgbToCMYK(51,86,22,&c,&m,&y,&k);
  assert_true(
    isClose(c, .41) &&
    isClose(m, 0.0) &&
    isClose(y, .74) &&
 ...
 * rgb-value (70, 86, 250).
 */
static void testRgbToCmyk004(void **state) {
  double c, m, y, k;
  rgbToCMYK(70,86,250,&c,&m,&y,&k);
  assert_true(
    isClose(c, .72) &&
    isClose(m, .66) &&
    isClose(y, 0.0) &&
...
/**
 * This function tests cmykToRGB passing a single, hard-coded
 * cmyk-value (0.0, .35, .17, .08).
 */
static void testCmykToRgb002(void **state) {
    int r, g, b;
    cmykToRGB(0.0, .35, .17, .08, &r, &g, &b);
    assert_true(
            r == 235 &&
            g == 152 &&
            b == 195
...
/**
 * This function tests cmykToRGB passing a single, hard-coded
 * cmyk-value (.41, 0.0, .74, .66).
 */
static void testCmykToRgb003(void **state) {
    int r, g, b;
    cmykToRGB(.41, 0.0, .74, .66, &r, &g, &b);
    assert_true(
            r == 51 &&
            g == 87 &&
            b == 23
...
/**
 * This function tests cmykToRGB passing a single, hard-coded
 * cmyk-value (.72, .66, 0.0, .02).
 */
static void testCmykToRgb004(void **state) {
    int r, g, b;
    cmykToRGB(.72, .66, 0.0, .02, &r, &g, &b);
    assert_true(
            r == 70 &&
            g == 85 &&
            b == 250
...
int main(int argc, char **argv) {
    ...
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test(testRgbToCmyk002),
            cmocka_unit_test(testRgbToCmyk003),
            cmocka_unit_test(testRgbToCmyk004),
            ...
            cmocka_unit_test(testCmykToRgb003),
            cmocka_unit_test(testCmykToRgb004),
